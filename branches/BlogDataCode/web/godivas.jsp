...
<html>
    ...
    <body class="yui-skin-sam">
        ...
        <div id="topRight">
            <c:if test="${pageContext.request.userPrincipal != null}"><b>Welcome</b>, ${identifier}</c:if> | <a href="logout.jsp">Logout</a>
        </div>
        ...
        <div id="mainPanel">
            ...
            <div id="imagePanel" class="imagePanel">
                ...
                <div id="underMap"><span id="testImage"></span>&nbsp;&nbsp;<span id="googleEarth"></span>&nbsp;&nbsp;<span id="screenshot" style="visibility:hidden"><a href="#" onclick="javascript:loadScreenshot()">Screenshot</a></span>&nbsp;&nbsp;<span id="blog" style="visibility:hidden"><a href="#" onclick="javascript:loadBlogPost()">Post blog</a></span></div>
        ...
        <!-- The "blog login loading" pop-up window.  Initially invisible. -->
        <div id="blogPanel" style="visibility: hidden">
            <div class="hd">Enter details below</div>
            <div class="bd">
                <div style="height:350px; width:350px; background-color: #ffffff; padding: 1em; overflow: auto">
                    <form name="blogging" action="/ncWMS/blog" method="post">
                        <div>
                            <b><br/>Some Text: <br/></b><textarea name="btext" rows="15" cols="60"></textarea><br>
                            <input type="text" name="bopenid" value= ${identifier} style="visibility:hidden">

                            <input type="hidden" name=datasetid>
                            <input type="hidden" name=title>
                            <input type="hidden" name=urlBG>
                            <input type="hidden" name=urlFG>
                            <input type="hidden" name=urlPalette>
                            <input type="hidden" name=upperValue>
                            <input type="hidden" name=twoThirds>
                            <input type="hidden" name=oneThird>
                            <input type="hidden" name=lowerValue>
                            <input type="hidden" name=latLon>
                            <input type="hidden" name=geom>
                            <input type="hidden" name=url>
                            <input type="hidden" name=elevation>
                            <input type="hidden" name=timetxt>
