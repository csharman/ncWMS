...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
    ...
    public AuthSSLProtocolSocketFactory(
            String keystoreUrl, final String keystorePassword,
            String truststoreUrl, final String truststorePassword) {
        super();
    ...
    private static KeyStore createTrustStore(final String url, final String password)
            throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException {
        if (url == null) {
            throw new IllegalArgumentException("Keystore url may not be null");
        }
    ...
    private SSLContext createSSLContext() {
        try {
            ...
            if (this.truststoreUrl != null) {
                KeyStore keystore = createTrustStore(this.truststoreUrl, this.truststorePassword);
                if (LOG.isDebugEnabled()) {
                    Enumeration aliases = keystore.aliases();
                    while (aliases.hasMoreElements()) {
                        String alias = (String) aliases.nextElement();
