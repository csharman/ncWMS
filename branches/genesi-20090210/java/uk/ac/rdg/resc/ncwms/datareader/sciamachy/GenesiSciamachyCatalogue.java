...
import uk.ac.rdg.resc.ncwms.security.SecureStore;
...
public class GenesiSciamachyCatalogue extends AbstractSciamachyCatalogue {
    ...
    private static final DateTimeFormatter DATE_TIME_PARSER = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSSSSS'Z'").withZone(DateTimeZone.UTC);
    ...
    public void populateCatalogue() throws DocumentException {
        ...
        for (Node node : datasets) {
            ...
            String urlStr = node.selectSingleNode("dclite4g:onlineResource/ws:HTTPS/@rdf:about").getText();
    ...
    protected SciamachySwath readSwath(String dataFileUrl) throws IOException {
        ...
        try {
            ...
            String proxyPath = "C:/OpenSSL/bin/asantokhee.p12";
            String proxyPassword = "test123";

            //download data using proxy cert.
            SecureStore ss = new SecureStore(proxyPath, proxyPassword, dataFileUrl);
            SciamachySwath swath = SciamachySwath.fromInputStream(ss.getHttpsConn().getInputStream());
