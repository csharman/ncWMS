 ...
 Godiva2.Map = OpenLayers.Class({
    ...
    initialize: function (div) {
		...
		this.map.addControl(nav);
                ...
                this.map.addLayers([bluemarble_wms, demis_wms, ol_wms, osm_wms, human_wms, northPoleBaseLayer, southPoleBaseLayer, this.drawinglayer /*, seazone_wms, essi_wms*/]);

                this.map.setBaseLayer(demis_wms);
